    ...
    <form action="/trip/scheduleupdate" method="post" id="customerForm" class="form-horizontal">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7">
                    <input type="text" name="date" readonly="" value="{{ \Carbon\Carbon::parse($det->date)->format('d M Y')}}" autocomplete="off" class="form-control form-control-inline date-picker" data-date-format="dd M yyyy">
                </div>
            </div>
            <div class="form-group">
